...
from src.transformers import (XLNetConfig, XLNetModel, XLNetLMHeadModel, XLNetForSequenceClassification, XLNetForQuestionAnswering)
from src.transformers.modeling_xlnet import XLNET_PRETRAINED_MODEL_ARCHIVE_MAP
